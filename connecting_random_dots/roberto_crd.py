...
class Fragment_point:
    """
        ...
        Also controls the connections beetwen other points and the mouse.
    """
    def __init__(self, initial_position) -> None:
        self.radium = randint(1,2)                                                       # The point radius                                                           
        self.possible_speed = [-3, -2, -1, 1, 2, 3]                                      # List of all possible speed's
        self.speed = [choice(self.possible_speed), choice(self.possible_speed)]          # Random initial speed
        self.in_use_color = choice([(255, 255, 255), (155, 155, 155), (200, 200, 200)])  # Random 
        self.position = [initial_position[0], initial_position[1]]                       # Point position on screen
        self.point_distance, self.mouse_distance = randint(10, 100), 200                 # Other point and mouse distance to connect
        self.mouse_pos = pygame.mouse.get_pos()                                          # To store the mouse position
    
    def get_position(self) -> list:
        """
            The point possition is returned to be used on the other point
            to calcum the proximity from other points.
        """
        return self.position

    def euclidean_distance(self, p1, p2) -> int:
        """
            Eucliean distance calcum
        """
    ...
    def mouse_connection(self) -> None:
        ...
        if(self.euclidean_distance((self.mouse_pos[0], self.mouse_pos[1]), (self.position[0], self.position[1])) <= self.mouse_distance)\
            and self.mouse_pos[0] in range(10, WIDTH-10) and self.mouse_pos[1] in range(10, HEIGHT-10):
    ...
    def change_direction(self):
        """
            When the fade out of the screenm this funtion will invert their 
            direction.
        """
...
class Animation:
    ...
    def draw_all_points(self) -> None:
        """
            This function draw all the points on the screen and also the mouse conections to.
        """
